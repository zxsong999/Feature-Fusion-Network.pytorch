...
parser.add_argument('--resume_KPS', default=None, type=str, metavar='PATH')  # L2cons  long-tailed
parser.add_argument('--resume_CE', default=None, type=str, metavar='PATH')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if is_best:
            best_epoch = epoch
            plot_norms(classifier,labelnames)
