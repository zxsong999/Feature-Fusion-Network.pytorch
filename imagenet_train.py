...
parser.add_argument('--loss_type', default="KPS", type=str, help='loss type')  # LDAM GCL
parser.add_argument('--imb_type', default="exp", type=str, help='imbalance type')
parser.add_argument('--imb_factor', default=None, type=str, help='imbalance factor')
parser.add_argument('--train_rule', default='GA', type=str, help='data sampling strategy for train loader')
parser.add_argument('--mixup', default=False, type=bool, help='if use mix-up')
parser.add_argument('--rand_number', default=666, type=int, help='fix random number for data sampling')
parser.add_argument('--exp_str', default='BS64-0.2', type=str,  # bs128
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        elif args.loss_type == 'KPS':
            criterion = KPSLoss(cls_num_list=cls_num_list, max_m=0.35, s=15, weighted=weighted,
